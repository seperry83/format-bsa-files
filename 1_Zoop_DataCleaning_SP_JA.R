...
rm(list=ls(all=TRUE))
setwd("C:/Users/jadams/Documents/R/")
#BSA Data Cleanup
...
filePath = 'C:/Users/jadams/Documents/R/'
excelFile = c('20211013 YB Zooplankton ID Data Sheet - SAMPLES 22 - 45 - Contract 4600012453_50um.xlsx') #keep parentheses; add multiple excel files if wanted
